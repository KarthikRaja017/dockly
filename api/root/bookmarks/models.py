    ...
    def post(self, uid, user):
        ...
        if editing and bookmark_id:
            ...
            payload = {
                ...
                "tags": data.get("tags", []),
                "hub": data.get("hub"),  # Add hub field
...
class GetBookmark(Resource):
    ...
    def get(self, uid, user):
        ...
        hub = args.get("hub")  # Add hub parameter
...
class ShareBookmark(Resource):
    ...
    def post(self, uid, user):
        ...
        for member_email in tagged_members:
            ...
            "hub": bookmark.get("hub"),  # Add hub field    
