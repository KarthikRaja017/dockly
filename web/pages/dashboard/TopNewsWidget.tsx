    ...
    useEffect(() => {
        const fetchCountryCode = async () => {
            try {
                ...
                setCountryCode(data?.country_code || navigator.language.split('-')[1] || 'US');
            } catch {
                    ...
                    {articles.length > 0 && (
                        <div style={{
                            ...
                            <div style={{ display: 'flex', gap: 6, fontSize: 9, marginTop: 8 }}>
                                ...
                                <div onClick={toggleBookmark} style={{ cursor: 'pointer', padding: 4 }}>
                                    {bookmarked ? (
                                ...
                                <Share size={10} color="#64748b" style={{ cursor: 'pointer', padding: 4 }} />
                            </div>
                        </div>
                    )}
