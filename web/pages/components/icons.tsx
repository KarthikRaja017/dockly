...
export function FlatColorIconsCalendar(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
...
export function FlatColorIconsHome(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={20}
...
export function FluentColorPeopleCommunity48(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <g fill="none">
        <path
          fill="url(#fluentColorPeopleCommunity480)"
          d="M24 5a6.5 6.5 0 1 0 0 13a6.5 6.5 0 0 0 0-13"
        ></path>
        <path
          fill="url(#fluentColorPeopleCommunity481)"
          d="M9.5 9a5.5 5.5 0 1 0 0 11a5.5 5.5 0 0 0 0-11"
        ></path>
        <path
          fill="url(#fluentColorPeopleCommunity482)"
          d="M38.5 9a5.5 5.5 0 1 0 0 11a5.5 5.5 0 0 0 0-11"
        ></path>
        <path
          fill="url(#fluentColorPeopleCommunity483)"
          d="M30.478 21.818a3.25 3.25 0 0 0-3.98 2.298l-1.489 5.554a9 9 0 1 0 17.387 4.659l1.488-5.554a3.25 3.25 0 0 0-2.298-3.98z"
        ></path>
        <path
          fill="url(#fluentColorPeopleCommunity484)"
          d="M17.522 21.818a3.25 3.25 0 0 1 3.98 2.298l1.488 5.554a9 9 0 1 1-17.386 4.66l-1.489-5.554a3.25 3.25 0 0 1 2.299-3.98z"
        ></path>
        <path
          fill="url(#fluentColorPeopleCommunity485)"
          d="M18.25 21A3.25 3.25 0 0 0 15 24.25V32a9 9 0 1 0 18 0v-7.75A3.25 3.25 0 0 0 29.75 21z"
        ></path>
        <defs>
          <radialGradient
            id="fluentColorPeopleCommunity480"
            cx={0}
            cy={0}
            r={1}
            gradientTransform="rotate(59.931 3.08 24.51)scale(8.11995)"
          ...
          <radialGradient
            id="fluentColorPeopleCommunity481"
            cx={0}
            cy={0}
            r={1}
            gradientTransform="rotate(47.573 -10.4 14.318)scale(9.01943)"
            gradientUnits="userSpaceOnUse"
          >
          ...
          <radialGradient
            id="fluentColorPeopleCommunity482"
            cx={0}
            cy={0}
            r={1}
            gradientTransform="rotate(78.837 11.016 28.388)scale(8.06859)"
            gradientUnits="userSpaceOnUse"
          >
          ...
          <radialGradient
            id="fluentColorPeopleCommunity483"
            cx={0}
            cy={0}
            r={1}
            gradientTransform="rotate(78.837 -.87 32.568)scale(14.1533)"
            gradientUnits="userSpaceOnUse"
          >
            <stop stopColor="#0078d4"></stop>
            <stop offset={1} stopColor="#004695"></stop>
          ...
          <radialGradient
            id="fluentColorPeopleCommunity484"
            cx={0}
            cy={0}
            r={1}
            gradientTransform="matrix(10.17127 18.39183 -13.2385 7.32131 8.733 22.61)"
            gradientUnits="userSpaceOnUse"
          >
            <stop stopColor="#008ce2"></stop>
            <stop offset={1} stopColor="#0068c6"></stop>
          ...
          <radialGradient
            id="fluentColorPeopleCommunity485"
            cx={0}
            cy={0}
            r={1}
            gradientTransform="matrix(5.63317 10.81113 -10.2173 5.32376 22.267 28.022)"
            gradientUnits="userSpaceOnUse"
          >
            <stop offset={0.339} stopColor="#3dcbff"></stop>
            <stop offset={1} stopColor="#14b1ff"></stop>
...
export function FluentEmojiDollarBanknote(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={20}
    ...
    >
      <g fill="none">
        ...
        <rect
          ...
          rx={2.2}
        ></rect>
        <g filter="url(#f398id8)">
          <path
            fill="url(#f398id3)"
            fillRule="evenodd"
            d="M27.063 10.156H4.938a.75.75 0 0 0-.75.75v12.532c0 .414.335.75.75.75h22.125a.75.75 0 0 0 .75-.75V10.906a.75.75 0 0 0-.75-.75m-22.125-.75a1.5 1.5 0 0 0-1.5 1.5v12.532a1.5 1.5 0 0 0 1.5 1.5h22.125a1.5 1.5 0 0 0 1.5-1.5V10.906a1.5 1.5 0 0 0-1.5-1.5z"
            clipRule="evenodd"
          ></path>
        </g>
        <ellipse
        ...
        <ellipse
          ...
          ry={4.266}
        ></ellipse>
        <g filter="url(#f398id9)">
          <path fill="#127531" d="M14.969 8.313h4.156v18h-4.312z"></path>
        </g>
        <g filter="url(#f398ida)">
          <path fill="#0b3f2e" d="M14.984 29.719h4.141v-3.407h-4.312z"></path>
        </g>
        <path
          fill="url(#f398id5)"
          d="M15.063 8.031h4.375v21.875h-4.375z"
        ></path>
        <path
          fill="url(#f398id6)"
          d="M15.063 8.031h4.375v21.875h-4.375z"
        ></path>
        <g filter="url(#f398idb)">
          <path
            fill="url(#f398id7)"
            d="M9.04 13.543a.613.613 0 0 1 1.226 0v.675c1.001.245 1.482 1.034 1.55 1.696c.04.377-.167.633-.497.667a.6.6 0 0 1-.658-.535c-.022-.216-.138-.843-1.06-.843c-1.32 0-1.351 1.742.18 1.742c.656 0 1.35.38 1.664.817c.327.454.434.953.363 1.454c-.192.842-.778 1.341-1.542 1.517v.65a.613.613 0 1 1-1.227 0v-.636c-.856-.183-1.465-.797-1.574-1.731c-.039-.33.167-.628.496-.667a.6.6 0 0 1 .666.526c.02.164.085.395.228.572c.121.152.328.287.747.287c.52 0 .797-.19.93-.406c.406-.586-.07-1.312-.778-1.312c-.949-.04-1.414-.28-1.793-.692a1.9 1.9 0 0 1-.496-1.258c0-.297.087-.778.413-1.175a2.02 2.02 0 0 1 1.161-.692z"
          ></path>
        </g>
        <defs>
          <linearGradient
          ...
          <radialGradient
            ...
            cy={0}
            r={1}
            gradientTransform="matrix(12.93753 14.5 -19.01468 16.96571 2.688 8.75)"
            gradientUnits="userSpaceOnUse"
          >
          ...
          <radialGradient
            ...
            cy={0}
            r={1}
            gradientTransform="rotate(-40.802 34.41 -19.1)scale(4.83012 4.74756)"
            gradientUnits="userSpaceOnUse"
          >
...
export function MaterialIconThemeFolderConnectionOpen(
...
export function NotoKey(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path
        fill="#dba010"
        d="M5.6 113.59s1.24.84 2.24 5.07l47.48-48.27c1.55-1.7-5.4-.82-7.48 1.25z"
      ></path>
      <path
        fill="#fff59d"
        d="M60.43 19.92c-3.9 2.12-8.3 7.8-9.51 16c-1.1 7.44-.63 12.61 1.87 16.96c2.83 4.91 6.68 2.31 5.13-2.47c-1.02-3.15-1.28-4.34-1.42-7.68c-.11-2.61.16-5.24.9-7.74c1.84-6.2 6.11-10.27 7.36-12.28c1.59-2.57-.92-4.66-4.33-2.79m-27.38 59.8c-2.84 2.42.1-5.11 2.28-7.65C38.2 68.71 45 61.58 46.2 60.97c1.64-.83 1.54 3.75.87 4.59C44.69 68.5 35.9 77.3 33.05 79.72"
      ></path>
    </svg>
  );
}

export function FxemojiCloud(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={20}
