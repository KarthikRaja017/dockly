...
const Provider = ({
  ...
  contact,
  category = "Medical",
}: Provider) => ({ name, specialty, contact, category });
...
// Optionally, if you want to keep the Medication function for creating objects:
const createMedication = ({
  ...
  isSoon,
  category = "Medical",
}: Medication) => ({ name, meta, schedule, refill, isSoon, category });
interface GoalProps {
  title: string;
  targetDate: string;
  current: string;
...
const Activity = ({
  ...
  date,
  category = "Fitness",
}: Activity) => ({ icon, title, meta, value, date, category });
...
}: MentalHealthProps) => ({ title, description, date, category });
...
type CustomSectionProps = CustomSection;
...
const CustomSection = ({
  ...
  category,
  content,
}: CustomSection) => ({ id, title, category, content });

const HealthDashboard = () => {
  // State for dynamic data
  const [healthRecords, setHealthRecords] = useState<HealthRecord[]>([
    {
      name: "Annual Physical Results.pdf",
      source: "Google Drive • Feb 15, 2025",
      category: "Medical",
    },
    {
      name: "Vaccination Records.pdf",
      source: "Google Drive • Jan 10, 2025",
      category: "Medical",
    },
  ]);
  ...
  const [providers, setProviders] = useState<Provider[]>([
    {
      ...
      contact: "(555) 123-4567 • Springfield Medical Group",
      category: "Medical",
    },
    {
      name: "Dr. Jessica Chen",
      specialty: "Dermatologist",
      contact: "(555) 987-6543 • Westside Dermatology",
      category: "Medical",
    },
  ]);
  ...
  const [insuranceCards, setInsuranceCards] = useState<InsuranceProps[]>([
    {
  ...
  const [isCustomSectionModalVisible, setIsCustomSectionModalVisible] =
    useState(false);
    ...
    switch (activeTab) {
      ...
      case "Nutrition":
        return {
          ...
          count: goals.filter((g) => g.category === "Nutrition").length,
        };
      case "Mental Health":
        return {
          title: "Mental Health Overview",
          count: mentalHealthRecords.length,
        };
      default:
        return {
    ...
    if (editSection === "Health Records" && editItem) {
      setHealthRecords(
        healthRecords.map((item) =>
          item.name === editItem.name ? { ...item, ...values } : item
        )
      );
      ...
      setAppointments(
        appointments.map((item) =>
          item.title === editItem.title && item.time === editItem.time
            ? { ...item, ...values }
            : item
        )
      );
      ...
      setGoals(
        goals.map((item) =>
          item.title === editItem.title ? { ...item, ...values } : item
        )
      );
    } else if (editSection === "Recent Fitness Activities" && editItem) {
      setActivities(
        activities.map((item) =>
          item.title === editItem.title && item.date === editItem.date
            ? { ...item, ...values }
            : item
        )
      );
      ...
      setMentalHealthRecords(
        mentalHealthRecords.map((item) =>
          item.title === editItem.title && item.date === editItem.date
            ? { ...item, ...values }
            : item
        )
  ...
  // Render main column sections (left)
  const renderSections = () => {
        ...
        <Card
          ...
          title={
            ...
            >
              ...
              >
                <span
                  style={{ marginRight: "8px", opacity: 0.8, color: "#10b981" }}
                >
                  📊
                </span>{" "}
                Health Summary
              ...
              <Button
                onClick={() => handleEdit("Health Summary", null)}
                style={{
                  width: "28px",
                  height: "28px",
                  borderRadius: "6px",
        ...
        <Card
          ...
          title={
            ...
            >
              ...
              <Button
                onClick={() => handleEdit("Healthcare Providers", null)}
                style={{
                  width: "28px",
                  height: "28px",
                  borderRadius: "6px",
        ...
        <Card
          ...
          title={
            ...
            >
              ...
              <Button
                onClick={() => handleEdit("Health Records", null)}
                style={{
                  width: "28px",
                  height: "28px",
                  borderRadius: "6px",
              ...
              .map((record, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <Button
                      onClick={() => handleEdit("Health Records", record)}
                      style={{
                        width: "32px",
                        height: "32px",
                        borderRadius: "6px",
        ...
        <Card
          ...
          title={
            ...
            >
              ...
              <Button
                onClick={() => handleEdit("Recent Fitness Activities", null)}
                style={{
                  width: "28px",
                  height: "28px",
                  borderRadius: "6px",
          ...
          <List
            ...
            renderItem={(item, index) => (
              ...
              >
                ...
                <Button
                  onClick={() => handleEdit("Recent Fitness Activities", item)}
                  style={{
                    width: "32px",
                    height: "32px",
                    borderRadius: "6px",
          ...
          <Card
            ...
            title={
              ...
              >
                ...
                <Button
                  onClick={() => handleEdit("Health Goals", null)}
                  style={{
                    width: "28px",
                    height: "28px",
                    borderRadius: "6px",
            ...
            {filteredGoals.map((goal, index) => (
              <div
                ...
                style={{
                  ...
                  padding: "16px",
                  marginBottom:
                    index === filteredGoals.length - 1 ? "0" : "16px",
                }}
              >
                <div
                  style={{
                ...
                <Button
                  onClick={() => handleEdit("Health Goals", goal)}
                  style={{
                    marginTop: "8px",
                    width: "32px",
                    height: "32px",
    ...
    // Mental Health Records (moved to left column when activeTab is Mental Health)
    if (activeTab === "Mental Health") {
      sections.push(
          ...
          title={
            ...
            >
              ...
              >
                ...
                >
                  ({mentalHealthRecords.length} records)
                </span>
              </h3>
              <Button
                onClick={() => handleEdit("Mental Health Records", null)}
                style={{
                  width: "28px",
                  height: "28px",
                  borderRadius: "6px",
        ...
        >
          <List
            dataSource={mentalHealthRecords.filter(
            ...
            renderItem={(item, index) => (
              <List.Item
                style={{
                  ...
                  padding: "12px 0",
                  borderBottom:
                    index === mentalHealthRecords.length - 1
                      ? "none"
                      : "1px solid #e5e7eb",
                }}
              >
                ...
                <Button
                  onClick={() => handleEdit("Mental Health Records", item)}
                  style={{
                    width: "32px",
                    height: "32px",
                    borderRadius: "6px",
    ...
    // Nutrition Tracking (moved to left column when activeTab is Nutrition)
      ...
      sections.push(
          ...
          title={
            ...
            >
              ...
              >
                ...
                >
                  ({goals.filter((g) => g.category === "Nutrition").length}{" "}
                  goals)
                </span>
              </h3>
              <Button
        ...
        >
          ...
          <Button
            ...
            onClick={() => handleEdit("Nutrition Tracking", null)}
          >
            <PlusOutlined style={{ marginRight: "8px", opacity: 0.7 }} /> Add
            Nutrition Entry
          </Button>
        </Card>
      );
        ...
        <Card
          ...
          title={
            ...
            >
              ...
              <Button
                onClick={() => handleEdit("Upcoming Appointments", null)}
                style={{
                  width: "28px",
                  height: "28px",
                  borderRadius: "6px",
          ...
          {appointments
            ...
            .map((appointment, index) => (
              ...
              >
                ...
                <Button
                  onClick={() =>
                    handleEdit("Upcoming Appointments", appointment)
                  }
                  style={{
                    width: "32px",
                    height: "32px",
        ...
        <Card
          ...
          title={
            ...
            >
              ...
              <Button
                onClick={() => handleEdit("Medications", null)}
                style={{
                  width: "28px",
                  height: "28px",
                  borderRadius: "6px",
              ...
              >
                ...
                <div style={{ textAlign: "right" }}>
                  ...
                  <div
                    style={{
                      fontSize: "12px",
                      color: medication.isSoon ? "#f59e0b" : "#6b7280",
                    }}
                  >
                ...
                <Button
                  onClick={() => handleEdit("Medications", medication)}
                  style={{
                    width: "32px",
                    height: "32px",
                    borderRadius: "6px",
          ...
          title={
            ...
            >
              ...
              >
                ...
                >
                  ({insuranceCards.length} plans)
                </span>
              </h3>
              <Button
                onClick={() => handleEdit("Insurance Information", null)}
                style={{
                  width: "28px",
                  height: "28px",
                  borderRadius: "6px",
            ...
            .map((card, index) => (
              <div
                ...
                style={{
                  ...
                  padding: "16px",
                  marginBottom:
                    index === insuranceCards.length - 1 ? "0" : "16px",
                }}
              >
                <div style={{ fontSize: "14px", color: "#6b7280" }}>
                  {card.provider}
                ...
                <Button
                  onClick={() => handleEdit("Insurance Information", card)}
                  style={{
                    marginTop: "8px",
                    width: "32px",
                    height: "32px",
        ...
        sections.push(
            ...
            title={
              ...
              >
                ...
                <div style={{ display: "flex", gap: "8px" }}>
                  ...
                  <Button
                    onClick={() => handleEdit(section.id, null)}
                    style={{
                      width: "28px",
                      height: "28px",
                      borderRadius: "6px",
          ...
          >
            <List
              ...
              renderItem={(item: { title: string; description: string }, index) => (
                <List.Item
                  style={{
                    display: "flex",
                    alignItems: "center",
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", gap: "4px", marginBottom: "24px" }}>
        {["Overview", "Medical", "Fitness", "Nutrition", "Mental Health"].map(
          (tab) => (
            <div
              key={tab}
              style={{
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          >
            ...
            <div
              style={{ fontSize: "16px", fontWeight: "500", color: "#3355ff" }}
            >
              Add a new section
            </div>
            <div style={{ fontSize: "14px", color: "#6b7280" }}>
      ...
      >
        <Form form={customSectionForm} onFinish={handleAddCustomSection}>
          <Form.Item
            ...
            label="Section Title"
            rules={[
              { required: true, message: "Please enter the section title" },
            ]}
          >
          ...
          <Form.Item
            ...
            rules={[
              { required: true, message: "Please enter initial content" },
            ]}
          >
